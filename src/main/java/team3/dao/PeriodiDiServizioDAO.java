...
public class PeriodiDiServizioDAO {
    ...
    // salvo un periodo di servizio
    public void save(PeriodoDiServizio newPeriodo) {
        EntityTransaction transaction = entityManager.getTransaction();

        transaction.begin();

        entityManager.persist(newPeriodo);

        transaction.commit();

        System.out.println("Il periodo di servizio è stato correttamente salvato!");
    }
