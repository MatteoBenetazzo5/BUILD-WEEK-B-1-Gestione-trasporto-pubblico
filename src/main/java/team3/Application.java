...
//        Biglietto biglietto1 = new Biglietto("123ABC",LocalDate.now(), null,puntoVenditaRecuperato,mezzoRecuperato);
        ...
        Biglietto biglietto2Obj = new Biglietto("456DEF", LocalDate.now(), LocalDateTime.now(), puntoVenditaRecuperato, mezzoRecuperato);
//        bigliettiDAO.save(biglietto2);
        Biglietto biglietto3Obj = new Biglietto("789GHL", LocalDate.now(), LocalDateTime.now(), puntoVenditaRecuperato2, mezzoRecuperato2);
//        bigliettiDAO.save(biglietto3);
        Biglietto biglietto4Obj = new Biglietto("184THS", LocalDate.now(), LocalDateTime.now(), puntoVenditaRecuperato3, mezzoRecuperato3);
//        bigliettiDAO.save(biglietto4);
        ...
        // chiudo l'EntityManager usato per le “demo” sopra
        em.close();

        // avvio menu
        menuPrincipale();

        // chiusure finali (una sola volta)
        scanner.close();
        emf.close();
    }
            ...
            while (!back) {
                ...
                switch (scelta) {
                    case 1:
                        ...
                        System.out.println("Il tuo biglietto con codice: " + bigliettoDistributore.getCodiceUnivoco() + " Ã¨ stato generato con successo");
                    ...
                    case 2:
                        ...
                        if (valTessera) {
                            System.out.println("La tua tessera Ã¨ valida, ti genero l'abbonamento");
                            ...
                            System.out.println("\nL'abbonamento con codice: " + abbonamentoDistributore.getCodiceUnivoco() +
                                    " Ã¨ stato correttamente generato.");
                            System.out.println("Reindirizzamento al menu principale.");
                            return;

                        } else {
                            System.out.println("Purtroppo la tua tessera Ã¨ scaduta, creazione di una nuova tessera in corso.");
            ...
            while (!back) {
                ...
                switch (scelta) {
                    ...
                    case 1:
                        ...
                        System.out.println("La seguente tratta Ã¨ stata creata: " + trattaNuova);
                        break;
